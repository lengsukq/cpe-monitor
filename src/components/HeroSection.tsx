...
export default function HeroSection({
  ...
  return (
    <section className={cn('surface-hero px-4 py-5 sm:px-6 sm:py-7 lg:px-8', className)}>
      ...
      <div className="relative flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between sm:gap-6">
        <div>
          {eyebrow ? (
            <div className="mb-2 flex flex-wrap items-center gap-2 text-[10px] font-semibold uppercase tracking-[0.16em] text-brand/80 sm:text-xs sm:tracking-[0.2em]">
              {eyebrow}
            </div>
          ) : null}
